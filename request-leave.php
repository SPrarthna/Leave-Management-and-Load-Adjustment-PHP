...
<head>
  ...
  <title>Faculty | Request Leave</title>
                ...
                <div class="box box-primary">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="holidayFrom" name="from">
                        </div>
                        <div class="form-group">
                            <label for="holidayTo">To</label>
                            <input type="date" class="form-control" id="holidayTo" name="to">
                        </div>
                        <div class="form-group">
                         <label>Leave Reason:</label>
                         <textarea class="form-control" rows="3" placeholder="Enter reason" id="reason" name="reason"></textarea>
                       </div>
                       ...
                       <div class="form-group">
                        <label>Leave Type</label>
                            ...
                            <option value="">Select Type</option>
                                ...
                                {
                                    echo "<option>".$row[leave_type]."</option>";
                                 }
                                }
                                else{
